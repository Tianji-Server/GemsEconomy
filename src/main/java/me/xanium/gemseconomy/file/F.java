...
public class F {
    ...
    public static String getAddToAllMessage() {
        return getPrefix() + colorize(cfg.getString("Messages.add_all"));
    }
    ...
    public static String getGiveAllUsage() {
        return colorize(cfg.getString("Messages.usage.giveall_command"));
    }
